...
CloneCompiledGccTwelve(){
    ...
    if [ ! -e "${MainPath}/arm-zyc-linux-gnueabi-12.x-gnu-20210523.tar.gz" ];then
        wget -q  https://github.com/ZyCromerZ/compiled-gcc/releases/download/varm-zyc-linux-gnueabi-12.x-gnu-20210523/arm-zyc-linux-gnueabi-12.x-gnu-20210523.tar.gz
    fi
    ...
    if [ ! -e "${MainPath}/aarch64-zyc-linux-gnu-12.x-gnu-20210523.tar.gz" ];then
        wget -q https://github.com/ZyCromerZ/compiled-gcc/releases/download/vaarch64-zyc-linux-gnu-12.x-gnu-20210523/aarch64-zyc-linux-gnu-12.x-gnu-20210523.tar.gz
    fi
